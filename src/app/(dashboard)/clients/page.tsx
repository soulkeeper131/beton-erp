  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <Input
          placeholder="Търсене по име, фирма, ЕИК, телефон..."
          value={search}
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="p-8 text-center text-muted-foreground">
              {search ? "Няма намерени клиенти." : "Няма въведени клиенти."}
            </div>
          ) : (
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="hidden md:table-cell">Фирма</TableHead>
                    <TableHead className="hidden md:table-cell">ЕИК</TableHead>
                    <TableHead>Телефон</TableHead>
                    <TableHead className="hidden lg:table-cell">Имейл</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {clients.map((client) => (
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {editing ? "Редактиране на клиент" : "Нов клиент"}
            </DialogTitle>
          </DialogHeader>
          <Form {...form}>
